...
public class ProductController {
    ...
    @PostMapping("")
    public ResponseEntity<?> insertProduct(@RequestParam MultipartFile file,@RequestParam String name,
        ...
        boolean isSuccess = productServiceImp.insertProduct(name,file,price,quanity,
